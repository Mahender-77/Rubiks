...
export default function AdminIndex() {
  ...
  const recentJobs = [
    { id: 1, title: "Senior React Developer", company: "Google", applications: 45, status: "active", salary: "$120k-150k" },
    { id: 2, title: "UI/UX Designer", company: "Apple", applications: 32, status: "pending", salary: "$80k-100k" },
    { id: 3, title: "Data Scientist", company: "Microsoft", applications: 67, status: "active", salary: "$130k-160k" },
  ];

  const recentNews = [
    { id: 1, title: "Tech Industry Growth in 2024", views: 1234, status: "published", date: "2 hours ago" },
    { id: 2, title: "Remote Work Trends", views: 892, status: "draft", date: "1 day ago" },
    { id: 3, title: "AI Job Market Analysis", views: 2456, status: "published", date: "3 days ago" },
  ];
      ...
      <View style={styles.statsContainer}>
        ...
        <View style={styles.statsRow}>
          <View style={[styles.statCard, { backgroundColor: "#FFF3E0" }]}>
            ...
            <Text style={styles.statNumber}>{dashboardStats.newApplications}</Text>
        ...
        {recentJobs.map((job) => (
          <View key={job.id} style={styles.listItem}>
            <View style={styles.listItemLeft}>
              ...
              <Text style={styles.listItemSubtitle}>{job.company} • {job.salary}</Text>
              <Text style={styles.listItemMeta}>{job.applications} applications</Text>
            </View>
            <View style={styles.listItemRight}>
              <View style={[
                styles.statusBadge,
                { backgroundColor: job.status === 'active' ? '#E8F5E8' : '#FFF3E0' }
              ]}>
                <Text style={[
                  styles.statusText,
        ...
        {recentNews.map((news) => (
          <View key={news.id} style={styles.newsCard}>
            ...
            <View style={styles.newsCardFooter}>
              <View style={[
                styles.statusBadge,
                { backgroundColor: news.status === 'published' ? '#E8F5E8' : '#FFF3E0' }
              ]}>
                <Text style={[
                  styles.statusText,
                  { color: news.status === 'published' ? '#388E3C' : '#F57C00' }
                ]}>
                  {news.status}
                </Text>
              </View>
  ...
  const renderAnalytics = () => (
    <ScrollView showsVerticalScrollIndicator={false}>
      ...
      <View style={styles.analyticsCard}>
        <Text style={styles.analyticsTitle}>Job Applications Trend</Text>
        <View style={styles.chartPlaceholder}>
          <BarChart3 color="#87CEEB" size={48} />
      ...
      <View style={styles.analyticsCard}>
        ...
        <View style={styles.metricsRow}>
          <View style={styles.metric}>
            ...
            <Text style={styles.metricLabel}>Job Success Rate</Text>
          </View>
          <View style={styles.metric}>
      ...
      <View style={styles.analyticsCard}>
        <Text style={styles.analyticsTitle}>Top Performing Categories</Text>
        <View style={styles.categoryList}>
          <View style={styles.categoryItem}>
            <Text style={styles.categoryName}>Tech Jobs</Text>
            <Text style={styles.categoryPercentage}>45%</Text>
          </View>
          <View style={styles.categoryItem}>
            <Text style={styles.categoryName}>Remote Work</Text>
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.bottomNav}>
        ...
        >
          <BarChart3 color={activeTab === "dashboard" ? "#87CEEB" : "#666"} size={20} />
        ...
        <TouchableOpacity
          style={[styles.navItem, activeTab === "news" && styles.navItemActive]}
          onPress={() => setActiveTab("news")}
        >
          <Newspaper color={activeTab === "news" ? "#87CEEB" : "#666"} size={20} />
          <Text style={[styles.navText, activeTab === "news" && styles.navTextActive]}>
            News
          </Text>
        </TouchableOpacity>
        <TouchableOpacity
        ...
        >
          <TrendingUp color={activeTab === "analytics" ? "#87CEEB" : "#666"} size={20} />
        ...
        >
          <Settings color={activeTab === "settings" ? "#87CEEB" : "#666"} size={20} />
            ...
            <View style={styles.modalButtons}>
              ...
              <TouchableOpacity
                ...
                onPress={() => {
                  ...
                  Alert.alert('Success', `${modalType === 'job' ? 'Job' : 'News'} added successfully!`);
                }}
              >
